...
class PrivateConstructorTest {
    ...
    void privateConstructorWithParams_ignoredWhenStaticFactoryProvidesInstantiation() {
        Compilation compilation = Compiler.javac()
            ...
            .compile(README_PATTERN_FIXTURE);
    ...
    void privateConstructorWithParams_andNoFactory_reportsNoUsableConstructor() {
        Compilation compilation = Compiler.javac()
            .withProcessors(new TikoAnnotationProcessor())
            .compile(PRIVATE_CTOR_ONLY_FIXTURE);
        ...
        assertThat(compilation)
            .hadErrorContaining("@Component must have");
        assertThat(compilation)
            .hadErrorCount(1);
    }
    ...
    private static final JavaFileObject README_PATTERN_FIXTURE =
    ...
    private static final JavaFileObject PRIVATE_CTOR_ONLY_FIXTURE =
        JavaFileObjects.forSourceLines(
    ...
    private static final JavaFileObject PUBLIC_AND_PRIVATE_CTORS_FIXTURE =
        JavaFileObjects.forSourceLines(
