 ...
 * {@code Tiko.create(...)} call. {@link TransportError} is the non-sealed permit every
 * transport module ({@code tiko-kafka}, future {@code tiko-http}, ...) extends to surface
 * its own concrete error types without forcing a tiko-api update.
 *
