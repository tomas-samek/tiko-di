...
/**
 * Uninjectable side-effect bean: SINGLETON with {@code expose = {}} and
 * {@code exposeSelf = false}. Eagerly constructed at container start; its
 * {@code @EventHandler} method still fires on {@code ApplicationStartedEvent} despite
 * the bean being unreachable via {@code container.get(...)}.
 */
@Component(
