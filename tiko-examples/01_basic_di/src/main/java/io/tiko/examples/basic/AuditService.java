...
public class AuditService {
    ...
    public AuditService(RequestContext requestContext, EventContext eventContext) {
        ...
        System.out.println("[AuditService] RequestContext type: " + requestContext.getClass().getName());
        System.out.println("[AuditService] EventContext type: " + eventContext.getClass().getName());
