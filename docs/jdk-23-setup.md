...
```groovy
dependencies {
    implementation "io.github.tomas-samek:tiko-api:0.3.0"
    implementation "io.github.tomas-samek:tiko-runtime:0.3.0"
    annotationProcessor "io.github.tomas-samek:tiko-processor:0.3.0"
}
```
...
```bash
javac -proc:full \
      --processor-path tiko-processor-0.3.0.jar \
      -cp tiko-api-0.3.0.jar:tiko-runtime-0.3.0.jar \
      -d out \
